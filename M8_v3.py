...
trash_pap = pygame.image.load(DIR+"assets/img_v2/dechetterie.png").convert_alpha()
...
trash_img = {
    "1_1_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_1.png").convert_alpha(),
    "1_2_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_2.png").convert_alpha(),
    "1_3_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_3.png").convert_alpha(),
    "1_4_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_4.png").convert_alpha(),
    "1_5_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_5.png").convert_alpha(),
    "1_6_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_6.png").convert_alpha(),
    "1_7_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_7.png").convert_alpha(),
    "1_8_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_8.png").convert_alpha(),
    "1_9_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_9.png").convert_alpha(),
    "1_0_img" : pygame.image.load(DIR+"assets/trash_v3/1/1_0.png").convert_alpha(),

    "2_1_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_1.png").convert_alpha(),
    "2_2_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_2.png").convert_alpha(),
    "2_3_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_3.png").convert_alpha(),
    "2_4_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_4.png").convert_alpha(),
    "2_5_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_5.png").convert_alpha(),
    "2_6_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_6.png").convert_alpha(),
    "2_7_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_7.png").convert_alpha(),
    "2_8_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_8.png").convert_alpha(),
    "2_9_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_9.png").convert_alpha(),
    "2_0_img" : pygame.image.load(DIR+"assets/trash_v3/2/2_0.png").convert_alpha(),

    "3_1_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_1.png").convert_alpha(),
    "3_2_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_2.png").convert_alpha(),
    "3_3_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_3.png").convert_alpha(),
    "3_4_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_4.png").convert_alpha(),
    "3_5_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_5.png").convert_alpha(),
    "3_6_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_6.png").convert_alpha(),
    "3_7_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_7.png").convert_alpha(),
    "3_8_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_8.png").convert_alpha(),
    "3_9_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_9.png").convert_alpha(),
    "3_0_img" : pygame.image.load(DIR+"assets/trash_v3/3/3_0.png").convert_alpha(),

    "4_1_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_1.png").convert_alpha(),
    "4_2_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_2.png").convert_alpha(),
    "4_3_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_3.png").convert_alpha(),
    "4_4_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_4.png").convert_alpha(),
    "4_5_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_5.png").convert_alpha(),
    "4_6_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_6.png").convert_alpha(),
    "4_7_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_7.png").convert_alpha(),
    "4_8_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_8.png").convert_alpha(),
    "4_9_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_9.png").convert_alpha(),
    "4_0_img" : pygame.image.load(DIR+"assets/trash_v3/4/4_0.png").convert_alpha(),

    "5_1_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_1.png").convert_alpha(),
    "5_2_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_2.png").convert_alpha(),
    "5_3_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_3.png").convert_alpha(),
    "5_4_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_4.png").convert_alpha(),
    "5_5_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_5.png").convert_alpha(),
    "5_6_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_6.png").convert_alpha(),
    "5_7_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_7.png").convert_alpha(),
    "5_8_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_8.png").convert_alpha(),
    "5_9_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_9.png").convert_alpha(),
    "5_0_img" : pygame.image.load(DIR+"assets/trash_v3/5/5_0.png").convert_alpha(),
}
